    ...
    public static class Utility
    {
        public static string TranslateBossID(int bossID)
        {
            switch (bossID)
            {
                ...
                //Wing 7
                case  21964:    return "Cardinal Sabir";
                case  22006:    return "Cardinal Adina";
        ...
        public static (int group, int order) GetBossIDOrder(int bossID)
        {
            switch (bossID)
            {
                ...
                //Wing 5
                case  19767:    return (6, 0);
                case  19450:    return (6, 1);

                //Wing 6
                case -21562:    return (7, 0);
                case  21105:    return (7, 1);
                case  20934:    return (7, 2);

                //Wing 7
                case  21964:    return (8, 0);
                case  22006:    return (8, 1);
                case  22000:    return (8, 2);
